...
def input_error(func):
    ...
    користувачу максимально корисну інформацію,
    використовуючи докстрінг функції.
    """
    ...
    def inner(*args, **kwargs):
        try:
            ...
            if "unpack" in str(error):
                usage = get_usage_from_doc(func)
                return f"Неправильна кількість аргументів. {usage}"
