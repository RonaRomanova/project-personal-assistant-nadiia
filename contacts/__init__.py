"""
Модуль контактів для керування записами адресної книги та
інформацією про контакти.

Цей модуль надає класи для керування контактами з наступними компонентами:

Класи:
    AddressBook: Керує колекцією записів контактів
        з операціями пошуку, додавання та видалення.
    Record: Представляє один контакт з інформацією
        про ім'я, телефони та день народження.
